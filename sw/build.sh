...
$gcc_path/riscv64-unknown-elf-gcc -Wall -D$2 -DRV-O0  -falign-functions=4 -march=rv32ic -mabi=ilp32 -nostdlib -mstrict-align -T link.ld -o $name.elf -lgcc crt0.S "$1"  -lgcc
